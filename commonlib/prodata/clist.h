...
//        sem_init(&mgsem, 0, 0);
    ...
    int delete_list_data(DTYPE * val);
    int condition_delete_list_data(
             int (*condition_fun)(DTYPE &, DTYPE &), DTYPE &val);
...
template<class DTYPE, int N>
int C_LIST_T<DTYPE,N>::condition_delete_list_data(
         int (*condition_fun)(DTYPE &, DTYPE &), DTYPE &val)
{
...
template<class DTYPE, int N>
DTYPE * C_LIST_T<DTYPE,N>::buf_read_data(int (*condition_fun)(DTYPE &, DTYPE &),
                                       DTYPE &val)
{

...
int driver_info<Dri,Dev,Ext,INode, ONode,TDri,TDev,TExt,TINode, TONode>::driver_read_xml(QString name)
{
    ...
    if (!doc.setContent(&file, true, &errorStr, &errorLine,
     ...
     cout << doc_root.tagName().toStdString() <<endl;
